  ...
  return (
    <div class="min-h-screen p-8 md:p-16 max-w-4xl mx-auto">
      <header class="mb-16">
        ...
        <p class="text-xl text-gray-400 font-mono mb-6">
          {profile.tagline}
        </p>
      ...
      <main class="space-y-16">
        <section>
          <h2 class="text-2xl font-bold mb-6 border-b border-gray-800 pb-2">About</h2>
        ...
        <section>
          <h2 class="text-2xl font-bold mb-6 border-b border-gray-800 pb-2">Experience</h2>
          <div class="space-y-8">
            {profile.experience.map((role, i) => (
              <div key={i} class="modal-card p-6 rounded-lg">
                <div class="flex justify-between items-start mb-2">
                  ...
                  <span class="text-sm font-mono text-gray-500">{role.date}</span>
                </div>
                <div class="text-accent font-mono text-sm mb-3">{role.role}</div>
                <p class="text-gray-400 text-sm">{role.details}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section>
          <h2 class="text-2xl font-bold mb-6 border-b border-gray-800 pb-2">Projects</h2>
          <div class="grid md:grid-cols-2 gap-6">
            {profile.projects.map((project, i) => (
              <div key={i} class="modal-card p-6 rounded-lg">
                <h3 class="text-lg font-bold mb-2">{project.name}</h3>
                <p class="text-xs font-mono text-gray-500 mb-3">{project.role}</p>
      ...
      <footer class="mt-24 pt-8 border-t border-gray-900 text-center text-gray-600 text-sm font-mono">
        <p>Built with Qwik, ElectricSQL & AG-UI</p>
        <p class="mt-2">© 2026 Mihai Chindriș</p>
      </footer>
    </div>
  );
});
