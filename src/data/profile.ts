export const profile = {
  ...
  projects: [
    ...
    },
    {
      ...
      date: "Feb 2026",
      description: "Ongoing project building a self-hosted AI coding bot that lets me assign tasks to OpenCode directly from my phone through Beeper/Matrix. Features automatic room creation, error resilience, and command routing. Inspired by the OpenClaw project, codebeep brings personal AI assistance to my mobile workflow.",
